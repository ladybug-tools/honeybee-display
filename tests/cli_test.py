...
from honeybee_display.cli import model_to_vis_set_cli, model_to_vis_set, \
    ...
    model_comparison_to_vis_set, model_comparison_to_vis_set_cli
...
def test_model_envelope_edges_to_vis_set_shade_mesh():
    input_model = './tests/json/model_with_edges.hbjson'
...
def test_model_comparison_to_vis_set_cli():
    ...
    base_model = './tests/json/base_model.hbjson'
    incoming_model = './tests/json/incoming_model.hbjson'
